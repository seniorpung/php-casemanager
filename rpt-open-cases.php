...
//Build query       
$sql = "SELECT case_id, task_id, task_name, created_datetime, assigned_datetime, task_status_name, defaultSLA as days_to_complete, DATEDIFF(Now() ,assigned_datetime) as days_past_due,assigned_person FROM cases_detail_view where case_status_id in (1,4) " . $whereConditionStr;
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" novalidate method="get" action="rpt-open-cases.php">
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-6">
