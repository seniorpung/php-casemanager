<?php
    ...
    //Build query       
    $sql = "SELECT case_id, task_id, case_number, task_name, requester_name, created_datetime, assigned_person, task_status_name, defaultSLA FROM tasks_view where organization_id ='$org_id' ";
    $result = mysqli_query($link, $sql);

    ?><head>
        <title>Case Manager - All Tasks</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Tasks</h4>
