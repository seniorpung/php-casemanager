    ...
    $.widget("flowchart.flowchart", {
        ...
        _getOperatorFullElement: function (operatorData) {
            ...
            if(infos.isEditable == true) 
                var $operator = $('<div ondblclick="isEditable(\''+infos.dataindex+'\')" class="flowchart-operator '+infos.borderclass+'"></div>');
            else 
                var $operator = $('<div class="flowchart-operator '+infos.borderclass+'"></div>');
            $operator.addClass(infos.class);

            var $operator_title = $('<div id="'+infos.dataindex+'" class="flowchart-operator-title '+infos.dataclass+'" title="'+infos.title+'"></div>');
            $operator_title.html(infos.title);
            $operator_title.appendTo($operator);

            var $operator_body = $('<div class="flowchart-operator-body '+infos.dataindex+' '+infos.dataindex+'_assigned"></div>');
