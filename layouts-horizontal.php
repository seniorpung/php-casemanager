<?php 
    ...
    $total_cases        =   $crudObj->FindRecordsCount('cases', array('created_by='.$created_by));
    $total_open_cases   =   $crudObj->FindRecordsCount('cases', array('case_status_id=\'1\'', 'created_by='.$created_by));
    $total_closed_cases =   $crudObj->FindRecordsCount('cases', array('case_status_id=\'2\'', 'created_by='.$created_by));
    $OutofSLA           =   0;
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Horizontal Layout</a></li>
