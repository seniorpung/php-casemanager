...
if (isset($_GET['filter_btn'])) {
    ...
    $whereConditionStr = 'Where `created_datetime` >= CURDATE() - INTERVAL 365 DAY';
}

//Build query       
$sql = "SELECT task_id, case_number, task_name, requester_name, created_datetime, assigned_person, task_status_name, defaultSLA FROM casemanager.tasks_view " . $whereConditionStr;
...
<title>CaseManager - Staff Assignment Detail</title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Staff Assignment Detail</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Case Manager</a></li>
                                            <li class="breadcrumb-item active">Staff Assignment Detail</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" novalidate method="get" action="staff-assignment-detail.php">
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-6">
