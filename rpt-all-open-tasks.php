...
//Build query       
$sql = "SELECT assigned_person, task_id, task_name, created_datetime, assigned_datetime, task_status_name, defaultSLA as days_to_complete, DATEDIFF(Now() ,assigned_datetime) as days_past_due FROM casemanager.tasks_view where task_status_id in (1,3) " . $whereConditionStr;
...
<title>CaseManager - All Open Tasks</title>
            ...
            <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">All Open Tasks</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Case Manager</a></li>
                                            <li class="breadcrumb-item active">All Open Tasks</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="needs-validation" novalidate method="get" action="rpt-all-open-tasks.php">
                                    <div class="row mb-2">
                                        <div class="col-4">
                                            <div class="row">
                                                <div class="col-6">
