<?php
    ...
    $tasks = $crudObj->FindRow('tasks', $colsData, array('assigned_to != ""', 'case_id='.$_GET['case_id']));
    ...
    <!-- Begin page -->
        ...
        success:function(data){ 
            //console.log(data);
            if(data.travel_destination!=undefined){
                document.getElementById("travel_destination").value=data.travel_destination;
            }else{
            ...
            if(data.travel_first_name!=undefined){
                document.getElementById("travel_first_name").value=data.travel_first_name;
            }else{
                document.getElementById("travel_first_name").value="";
            }
            if(data.travel_last_name!=undefined){
                document.getElementById("travel_last_name").value=data.travel_last_name;
            }else{
                document.getElementById("travel_last_name").value="";
            }
            if(data.travel_purpose!=undefined){
                document.getElementById("travel_purpose").value=data.travel_purpose;
            }else{
        ...
        success:function(data){ 
            //console.log(data);
            if(data.employee_fname!=undefined){
                document.getElementById("employee_fname").value=data.employee_fname;
            }else{
                document.getElementById("employee_fname").value="";
            }
            if(data.employee_lname!=undefined){
                document.getElementById("employee_lname").value=data.employee_lname;
            }else{
            ...
            if(data.training_company_name!=undefined){
                document.getElementById("training_company_name").value=data.training_company_name;
            }else{
                document.getElementById("training_company_name").value="";
            }
            if(data.training_start_date!=undefined){
                document.getElementById("training_start_date").value=data.training_start_date;
            }else{
                document.getElementById("training_start_date").value="";
            }
            if(data.training_cost!=undefined){
                document.getElementById("training_cost").value=data.training_cost;
            }else{
                document.getElementById("training_cost").value="";
            }
            if(data.training_class_name!=undefined){
                document.getElementById("training_class_name").value=data.training_class_name;
            }else{
                document.getElementById("training_class_name").value="";
            }
            if(data.detail_instructions!=undefined){
                document.getElementById("detail_instructions").value=data.detail_instructions;
            }else{
