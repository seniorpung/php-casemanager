<?php
    ...
    {
        $assign_id=$_POST['id'];
        mysqli_query($link,"update tasks set assigned_to=".$_SESSION['id']." where task_id=$assign_id");
    }
    ...
    $group_id=mysqli_query($link,'select group_id from group_user where user_id='.$_SESSION['id'].';');
    $group_name=array();
    ...
    ?><head>
        <title>Case Manager - Group Queue</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h4 class="mb-sm-0 font-size-18">Group Queue</h4>
                                ...
                                <table id="datatable" class="table table-sm table-striped table-bordered dt-responsive nowrap w-100 mt-3 mb-3">
                                    ...
                                    if(isset($records) && count($records)>0){
                                        foreach($records as $record){
                                            ...
                                            ?><tr>
                                                <td>
                                                    <i  title="assign this task to myself" style="cursor:pointer;" onclick="assign(<?php echo $record['task_id'] ?>)" class="mdi mdi-account-check text-primary fa-lg "></i>
                                                </td>
                                                ...
                                                <td><?php echo date('m/d/Y h:i A', strtotime($record['case_created_datetime'])); ?></td>
                                                <td><?php echo $group_name[$record['assigned_to_group']] ?></td>                                                
                                            </tr><?php
                                        } 
                                    }
                                    ?></tbody>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3 mt-5">
                                            <form method="post">
                                                ...
                                                <button class="btn btn-primary waves-effect waves-light w-25 float-left" name="assign_btn">Yes !</button>
