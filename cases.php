<?php
    ...
    $records = $crudObj->FindAll('cases_view', array(), array('created_by=\''.$created_by .'\''), 0, 0, array(array('case_number', 'DESC')));
    ?><head>
        <title>Case Manager - My Cases</title>
    ...
    <!-- Begin page -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">My Cases</h4>
                                ...
                                <table id="datatable-buttons" class="table table-sm table-striped table-bordered dt-responsive nowrap w-100 mt-3 mb-3">
                                    ...
                                    if(isset($records) && count($records)>0){
                                        foreach($records as $record){
                                            ...
                                            ?><tr>
                                                <td><a href="cases-view.php?case_id=<?php echo $record['case_id']; ?>">
                                                ...
                                                <td><?php echo date('m/d/Y', strtotime($record['case_initial_file_date'])); ?></td>
        ...
        <script>
            ...
            function CaseAttachedDocViewModal(file_name, file_ext){
                ...
                var docFileExt = ["docx", "pptx", "pdf", "doc", "ppt"];
