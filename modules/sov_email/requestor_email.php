...
$query="select * from request_notifications_view where (task_id = 0) and (status is null or status ='')  and (contact_email is not null) order by created_date,id";
...
//$type = $row['type'];
$type = "Email";
$subject = "iRis BPM - Case" .$case_id. " - " .$row['case_subject'];
...
$message="Hello ".$name.",<br><br>  A new iRis BPM Case has been received at ".$created_time." on ".$created_date.".<br><br>The estimated resolution time for your case is ".$sla." days.<br><br>If you have any questions or you need to assistant, please contact your case manager.<br><br> Have a wonderful day!";
